    ...
    <section className="bg-white md:px-20 text-[#012C5D] space-y-16">
      ...
      <div className="flex flex-col md:flex-row items-start gap-6">
        <div className="flex-1">
          ...
          <p className="text-[24px]">
            ...
            combining education, technology, and health, we give them the skills
            to lead, advocate, and transform public health outcomes in their
            communities.
          </p>
        </div>
        <Image
      ...
      <div className="flex flex-col md:flex-row items-start gap-6 text-[24px]">
        <div className="flex-1">
          ...
          <ul className="list-disc pl-5 space-y-3">
            <li>
              Deliver engaging, science-based content on cardiovascular anatomy
              and function.
            </li>
            <li>
              Increase awareness of social determinants and disparities in heart
              health.
            </li>
            <li>
            ...
            <li>Connect heart health to leadership, action, and technology.</li>
          </ul>
        </div>
        <Image
          src="/worm.png"
      ...
      <div className="flex flex-col md:flex-row items-start gap-6 text-[24px]">
        <div className="flex-1">
          ...
          <ul className="list-disc pl-5 space-y-3">
            <li>
              <strong>Empowered Choices:</strong> Make informed decisions about
              food, activity, and wellness.
            </li>
            <li>
            ...
            <li>
              <strong>Community Action:</strong> Lead a heart health initiative
              — from walkathons to awareness posters.
            </li>
          </ul>
        </div>
        <Image
