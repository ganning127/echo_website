    ...
    <div className="w-full py-10">
      <div className="max-w-4xl mx-auto px-6 sm:px-10 flex flex-col items-center gap-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <a href="https://www.edecho.org/contact/partner">
            <button
          ...
          <a href="https://www.edecho.org/contact/general">
            <button
              className="font-heading bg-transparent text-[#013161] px-12 py-2 rounded-xl border-4 border-[#013161] shadow-md hover:bg-[#013161] hover:text-white transition-colors"
              style={{
                fontSize: "1.4rem",
              }}
            >
