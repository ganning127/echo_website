  ...
  return (
    <>
      <section className="w-full sm:mt-[25%] md:mt-[15%]">
        <FadeInWhenVisible>
          <div className="pt-10 w-5/6 justify-self-center grid grid-cols-1 md:grid-cols-5 gap-10 lg:gap-20">
            <div className="col-span-3 md:col-span-5 lg:col-span-2 lg:order-1 order-2 pb-10 mb-5 lg:text-[1.5vw]">
              <br />
              <h3 className="text-[6vw] lg:text-[3vw] text-[#013161]">
            ...
            <div className="col-span-3 md:col-span-5 lg:col-span-3 z-0 justify-self-center lg:order-1 order-1">
              <div className="bg-[#D7BDE7] border-[#7B5AA1] border-20 border-double w-full lg:w-[45vw]">
                <iframe
                  className="w-full lg:h-[25vw] md:h-[250px] h-[150px]"
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/qpmOABYdZbU?si=lJXYIXOHCEavBJJ8"
                  title="YouTube video player"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen"
                ></iframe>
              </div>
              <Image
                className="relative w-[45vw] m-auto"
