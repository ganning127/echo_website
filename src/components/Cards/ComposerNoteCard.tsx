  ...
  return (
    <>
      ...
      <p className="text-[3.5vw] sm:text-[1.5vw] text-base leading-relaxed">
        ...
        who listens to them. I’m passionate about breaking boundaries and making
        classical music more accessible to people through media scoring,
        imaginative concert experiences, and collaboration with artists in and
        outside of music. Although I specialize in classical, I’m interested in
