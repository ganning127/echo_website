        ...
        <div className="bg-[#DBECF1] min-h-screen">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5/6 mx-auto pt-10">
            <div className="col-span-3 lg:col-span-2 lg:pb-12 lg:pt-24 mx-auto lg:pr-24">
              ...
              >
                <p>LAST UPDATED: 07/25/2026</p>
              </div>
              <h1 className="text-5xl mb-5">Placemat 8: Heart-Healthy Habits</h1>
         ...
         <Image
                   className=""
                   src="/placemat/Explorations with ECHO & Friends - Food Bank Activity Sheet - HEART-HEALTHY HABITS.png"
                   alt="Heart-Healthy Habits Placemat"
                   width="700"
                   height="500"
                 />
                 
        <a href="/placemat/Explorations with ECHO & Friends - Food Bank Activity Sheet - HEART-HEALTHY HABITS.pdf" target="_blank" rel="noopener noreferrer">
        <button
