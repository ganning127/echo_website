...
export default function GeneralContactPage() {
  ...
  const sections = ["Your Information", "Your Message"];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        console.error("General contact submission failed:", await res.text());
        alert(
      ...
      console.error("General contact submission error:", err);
      alert(
        "Something went wrong submitting your message. Please try again."
      );
    } finally {
        ...
        <div className="min-h-screen bg-gradient-to-br from-[#013161] via-[#1876D0] to-[#329D3C] flex items-center justify-center p-4">
          ...
          >
            ...
            <p className="text-gray-600 text-lg mb-8 font-body">
              Your message has been sent. We&apos;ll get right back to you!
            </p>
            <Link
              href="/contact"
          ...
          <div className="w-full max-w-3xl">
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                ...
                {currentSection === 1 && (
                  <div className="space-y-6">
                    <h2 className="text-3xl text-white mb-6">Your Message</h2>

                    <div>
                      <label className="block text-white text-lg mb-2">
                        Subject <span className="text-[#FFD87A]">*</span>
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-white text-lg mb-2">
                        Message <span className="text-[#FFD87A]">*</span>
                      </label>
                      <textarea
