...
export default async function BlogPost({
  ...
  const pageUrl = `${process.env.NEXT_PUBLIC_SITE_URL ?? ""}/blog/${slug}`;
  ...
  const shareLinks = {
    ...
    email: `mailto:?subject=${encodedTitle}&body=I wanted to share this blog from ECHO(Early Cardiovascular Health Outreach): ${encodedUrl}`,
  };
          ...
          <div className="p-6 w-6/6 md:w-4/6 mx-auto pt-10 md:pt-32">
            ...
            <div className="py-10 flex items-center gap-4 justify-center">
              ...
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 text-sm font-medium text-gray-700 hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] transition-colors duration-200"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 text-sm font-medium text-gray-700 hover:bg-black hover:text-white hover:border-black transition-colors duration-200"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 text-sm font-medium text-gray-700 hover:bg-[#7C2D36] hover:text-white hover:border-[#7C2D36] transition-colors duration-200"
              >
